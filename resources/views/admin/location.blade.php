            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title">
                        ...
                        <a class="btn btn-success " href="{{route("admin_location_create")}}" style="margin:5px;">Add location</a>
                                ...
                                @foreach($datalist as $rs)
                                    <tr class="gradeX">
                                        ...
                                        <td style="width:180px;">
                                            <a href="{{ route("admin_location_edit",['id'=>$rs->id]) }}"
                                            ...
                                            <a href="{{ route("admin_location_destroy",['id'=>$rs->id]) }}" onclick="return confirm('Are You Sure To Delete')" class="btn btn-danger btn-mini" style="float: right;">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
