...
@section("title","SMT TRANSFER reservation")
@section("content")
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="/admin/reservation">Randevu</a>
                </li>
                                ...
                                @foreach($datalist as $rs)
                                    <tr class="gradeX">
                                        ...
                                        <td style="width:180px;">
                                            <a href="{{ route("admin_reservation_edit",['id'=>$rs->id]) }}"
                                               onclick=" return  !window.open(this.href,'targetWindow',
                                               'toolbar=no,location=center,status=no,menubar=no,scrollbars=yes,' +
                                                'resizable=no,width=600,height=500,top=100px,left=100px')"
                                               class="btn btn-primary btn-mini">Edit</a>
                                            <a href="{{ route("admin_reservation_destroy",['id'=>$rs->id]) }}"
