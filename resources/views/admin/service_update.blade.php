                ...
                <div class="ibox-content">
                    <form enctype="multipart/form-data" action="{{ route('admin_service_update',['id'=>$data->id]) }}" method="post" class="form-horizontal">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input value="{{$data->carModel}}" type="text" name="carModel" class="form-control"   />
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Capacity</label>
                            <div class="controls">
                                <input value="{{$data->capacity}}" type="number" name="capacity" class="form-control"   />
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label"> Base Price</label>
                            <div class="controls">
                                <input value="{{$data->price}}" type="number" name="price" step="any" class="form-control"   />
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label"> Km Price</label>
                            <div class="controls">
                                <input value="{{$data->km_price}}" type="number" name="km_price" step="any" class="form-control"   />
                            </div>
                        </div>
                        <div class="control-group">
